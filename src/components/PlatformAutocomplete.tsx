...
export const PlatformAutocomplete = () => {
  ...
  return (
    <Combobox className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5" as="div" value={selectedPlatform} onChange={setSelectedPlatform}>
      <Combobox.Label className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
        Platform
      </Combobox.Label>
      <div className="w-full relative mt-1 sm:col-span-2">
        <Combobox.Input
